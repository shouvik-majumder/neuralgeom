...
instrumental-variable correction for the finite-difference velocity bias
...
from .lds import (trial_velocities, fit_lds, fit_sliding_lds, fit_cubic_field,
                  ...
                  velocity_projections, norm_fraction_in_top_metric_eigenspace,
                  shuffle_null_r2, r2_score_multi)
from .regression import run_regression_suite, time_to_lick_regression
from . import lds

__all__ = ["recurrent_jacobian", "input_jacobian", "jacobian_spectrum",
           "recurrent_update_pullback_metric", "find_slow_points", "SlowPoints",
           ...
           "velocity_projections", "norm_fraction_in_top_metric_eigenspace", "shuffle_null_r2",
           "r2_score_multi", "run_regression_suite", "time_to_lick_regression"]
