"""
neuralgeom.geometry — the map-agnostic geometry toolbox.
===================================================

Nothing here knows about neurons, tasks or behaviour. Given a differentiable
map it computes the induced (pullback) geometry, and given the resulting
matrices it computes distances between them.
...
``manifold.py``.
"""
from .jacobian import (PullbackGeometry, batch_jacobian, log_volume_element,
...
from .grassmann import (GrassmannGeometry, grassmann_distance,
                        grassmann_frechet_mean, pairwise_grassmann_distance,
                        principal_angles, tangent_subspaces,
                        # numpy / geomstats frame-based API (merged from PSM)
                        SQRT2, frame_to_projector, projector_to_frame,
...
__all__ = [
    "batch_jacobian", "pullback_metric", "volume_element",
    "log_volume_element", "metric_spectrum", "PullbackGeometry",
    ...
    "grassmann_frechet_mean", "tangent_subspaces", "GrassmannGeometry",
    "SQRT2", "frame_to_projector", "projector_to_frame", "orthonormalize",
    "frame_principal_angles", "frame_distance", "frame_distance_matrix",
    "GrassmannManifold", "validate_fast_matches_geomstats",
